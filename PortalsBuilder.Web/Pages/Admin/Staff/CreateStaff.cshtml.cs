...
namespace PortalsBuilder.Web.Pages.Admin.Staff
{
    public class CreateStaffModel : PageModel
    {
        ...
        public CreateStaffModel(IStaffService staffService, IBranchService branchService, IOrganizationSerivce organizationSerivce)
        {
        ...
        public IActionResult OnPost(IFormFile imgCourseUp)
        {
            ...
            _staffService.AddStaff(Staff, imgCourseUp);

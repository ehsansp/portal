...
$(function() {
    ...
    function generate_message(msg, type) {
        ...
        str += "            <img src=\"\\UserAvatar\\User_Avatar.png\">";
        str += "          <\/span>";
...
$('.image-upload-wrap3').bind('dragover3', function () {
    $('.image-upload-wrap3').addClass('image-dropping3');
});
$('.image-upload-wrap3').bind('dragleave3', function () {
...
$('.image-upload-wrap4').bind('dragover4', function () {
    $('.image-upload-wrap4').addClass('image-dropping4');
});
$('.image-upload-wrap4').bind('dragleave4', function () {
...
$('.image-upload-wrap5').bind('dragover5', function () {
    $('.image-upload-wrap5').addClass('image-dropping5');
});
$('.image-upload-wrap5').bind('dragleave5', function () {
...
$('.image-upload-wrap6').bind('dragover6', function () {
    $('.image-upload-wrap6').addClass('image-dropping6');
});
$('.image-upload-wrap6').bind('dragleave6', function () {

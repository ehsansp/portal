...
using ShahrKoodak.Core.DTOs.SiteMap;
...
namespace ShahrKoodak.Core.Generator
{
    public class SiteMapBuilder
    {
        ...
        public void AddUrl(string url, DateTime? modified = null, ChangeFrequency? changeFrequency = null,
        ...
        private XElement CreateItemElement(SiteMapUrl url)
        {
            ...
            {
                itemElement.Add(new XElement(NS + "lastmod",
                    url.Modified.Value.ToString("yyyy-MM-ddTHH:mm:ss.f") + "+00:00"));
            }

...
namespace PortalBuilder.Core.Security
{
    public class GoogleReCaptchaValidationAttribute: ValidationAttribute
    {
        ...
        {
            Lazy<ValidationResult> errorResult = new Lazy<ValidationResult>(() => new ValidationResult("لطفاً تیک من ربات نیستم را بزنید", new String[] { validationContext.MemberName }));
